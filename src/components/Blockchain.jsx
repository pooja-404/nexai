...
const Blockchain = () => {
    ...
    const card = cards.map((cards, i) => (<div key={i} className={`lg:w-1/3 md:w-2/4  w-full px-5 flex justify-center group duration-500 py-16 ${cards.botm}`}>
        <div className="bg-[(url(./assets/images/blockcard.webp)] hover:scale-110 duration-500 object-cover w-[330px] h-[367px] flex flex-col items-center bg-no-repeat bg-center bg-BgSize " data-aos={`${cards.animation}`} data-aos-duration="1000" data-aos-offset="500"
    ...
    return (
        <div className='lg:py-20 py-14 relative z-10 Blockchain overflow-x-clip'>
            <div className="max-w-[1140px] mx-auto px-3" >
                ...
                <p className=' font-poppins leading-[25px] text-sm sm:text-base font-normal text-[#b3b7bb]  text-center pt-7 lg:max-w-[997px] mx-auto 'data-aos="zoom-in">Nexai is an advanced home assistant that will revolutionize the way we interact with our smart devices at home. Powered by sophisticated artificial intelligence, it leverages blockchain technology to offer a secure and efficient user experience.</p>
