...
function Unique() {
    return (
        <div className='max-lg:mx-3' id='features'>
            <div className=' relative z-[2]  max-w-[1340px] mx-auto lg:px-24 md:px-16 px-8 lg:my-24 overflow-hidden border-[1px] border-solid border-[#FCFCFC] rounded-[32px] bg-[url(./assets/images/un.webp)]  w-full bg-center bg-cover  object-cover bg-no-repeat' id='tokens'>
                ...
                <div className=' overflow-y-scroll sm:h-[590px] h-[520px] max-[475px]:h-[602px] flex flex-wrap flex-row -mx-3 mt-10  '>
                    <div className='md:w-1/2 w-full px-3 '>
                        <div className='md:max-w-[364px] max-!sm:h-[400px] pt-7 rounded-[16px] bg-white px-6 lg:pb-14 sm:pb-10 pb-6  mt-6 hover:shadow-[0_0_10px_5px_#02CDCF] transition-all duration-300'>
                            <Unique1 />
                            <p className='font-recharge font-bold text-base sm:text-xl text-[#0B0A0A] lg:leading-[32px] pt-6 '>Remote Access and File Management</p>
                        ...
                        <div className='md:max-w-[364px] max-!sm:h-[400px] pt-7 rounded-[16px] bg-white px-6 lg:pb-14 sm:pb-10 pb-6  lg:mt-52 mt-8 hover:shadow-[0_0_10px_5px_#02CDCF] transition-all duration-300 '>
                            <Unique3 />
                            <p className='font-recharge font-bold text-base sm:text-xl text-[#0B0A0A] lg:leading-[32px] pt-6 '>Autonomous and Natural Language Communication</p>
                    ...
                    <div className='md:w-1/2 w-full px-3 '>
                        <div className='lg:flex justify-end  lg:mt-[378px] mt-8 '>
                            <div className=' pt-7 md:max-w-[364px] max-!sm:h-[400px] rounded-[16px] bg-white px-6 lg:pb-14 sm:pb-10 pb-6  hover:shadow-[0_0_10px_5px_#02CDCF] transition-all duration-300'>
                                <Unique2 />
                                <p className='font-recharge font-bold text-base sm:text-xl text-[#0B0A0A] lg:leading-[32px] pt-6 '>Real-time Home Monitoring</p>
                        ...
                        <div className='lg:flex justify-end  lg:mt-80 my-8 lg:mb-10'>
                            <div className=' pt-7 md:max-w-[364px] max-!sm:h-[400px] rounded-[16px] bg-white px-6 lg:pb-14 sm:pb-10 pb-6  hover:shadow-[0_0_10px_5px_#02CDCF] transition-all duration-300'>
                                <Unique4 />
                                <p className='font-recharge font-bold text-base sm:text-xl text-[#0B0A0A] lg:leading-[32px] pt-6 '>Intelligent Contextual Awareness</p>
