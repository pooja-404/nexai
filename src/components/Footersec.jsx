                        ...
                        <div className='flex flex-wrap flex-row -mx-3 lg:pb-5'>
                            <div className='w-1/2 px-3'>
                                <ul>
                                    ...
                                    <li className='lg:pt-3 pt-2'><a href="#features" className='text-[#b3b7bb] font-recharge font-bold text-sm sm:text-base leading-[19px]  relative after:absolute after:w-0 after:h-[2px] hover:after:absolute after:bottom-[-5px] hover:after:w-full after:left-[50%] transition-all duration-500 after:hover:left-0 after:transition-all after:duration-500 hover:after:bg-[#02CDCF] '>Features</a></li>
