...
function Backtotop() {
    ...
    return (
        ...
        <div onClick={scrollToTop} className=' overflow-hidden relative z-20'>
                <button className="bg-[#02CDCF] group duration-300 hover:scale-95  fixed bottom-5 right-3 sm:right-5 rounded-full p-3 shadow-[0_0_14px_9px_#02CDCF] hover:shadow-[0_0_14px_9px_#fff]   ">
